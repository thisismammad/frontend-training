...
<SectionWrapper id="hero">
  ...
  >
    <h2
      class="text-5xl font-semibold sm:text-6xl md:text-7xl lg:text-8xl max-w-[1200px] mx-auto w-full text-center"
    >
    ...
    <p
      class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000px] mx-auto"
    >
